...
- 统一授权:[Apache Directory](https://directory.apache.org),[OpenLDAP](http://www.openldap.org),[JumpServer](https://github.com/jumpserver/jumpserver),[ranger](https://ranger.apache.org)
- 数据存储:[mysql](https://www.mysql.com),[mongodb](https://www.mongodb.com),[cassandra](http://cassandra.apache.org),[H2](http://www.h2database.com),[SQLite](http://www.sqlite.org),Oracle,SqlServer,[FoundationDB](https://github.com/apple/foundationdb),[kudu](https://kudu.apache.org)
...
- 日志采集:[flume](http://flume.apache.org),[logstash](https://www.elastic.co/cn/products/logstash),[pulsar](https://pulsar.apache.org/zh-CN)
...
- 任务调度:[Oozie](http://oozie.apache.org/),[airflow](https://airflow.apache.org/),[quartz](http://www.quartz-scheduler.org)
...
- 前端框架:[Angular](https://angular.cn),[Vue](https://cn.vuejs.org),[React](https://reactjs.org),[jQuery](https://jquery.com),[Bootstrap](http://getbootstrap.com),[前端流程图](https://github.com/alibaba/butterfly),[excalidraw白板](https://github.com/excalidraw/excalidraw),[zwibbler](https://zwibbler.com)
...
- 桌面应用:[Electron](https://www.electronjs.org),[NW](https://nwjs.io)
